-- ── Apps ─────────────────────────────────────────────────────────────────────
hl.bind("SUPER + SPACE", hl.dsp.exec_cmd("rofi -show drun -modi drun -theme ~/.config/rofi/spotlight.rasi"))
...
hl.bind("SUPER + V", hl.dsp.exec_cmd("bash -c 'cliphist list | rofi -dmenu -display-columns 2 -theme ~/.config/rofi/cliphist.rasi | cliphist decode | wl-copy'"))
...
hl.bind("XF86AudioMicMute",      hl.dsp.exec_cmd("~/.local/bin/mic-mute-toggle.sh"), { locked = true, repeating = true })
hl.bind("XF86Launch6",           hl.dsp.exec_cmd("~/.local/bin/mic-mute-toggle.sh"), { locked = true, repeating = true })
hl.bind("SHIFT + XF86AudioLowerVolume", hl.dsp.exec_cmd("~/.local/bin/mic-vol-down.sh"), { locked = true, repeating = true })
hl.bind("SHIFT + XF86AudioRaiseVolume", hl.dsp.exec_cmd("~/.local/bin/mic-vol-up.sh"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessUp",   hl.dsp.exec_cmd("swayosd-client --brightness +1"),  { locked = true, repeating = true })
